...
\begin{itemize}
 ...
 \begin{enumerate}
  ...
  \item Before a scilab can be translated to c file, some function annotations should be added manually. Function annotations gives information about no. of inputs/outputs, 
 ...
 \end{enumerate}
 \item \textbf{Generating code for AVR}
\end{itemize}
