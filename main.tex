...
\input{how_to_use_scilab2c}
\newpage
\input{manuals/developer_manual}
\newpage
\section{Flowcharts}
\newgeometry{top=2cm, bottom=0.5cm,right=1cm,left=1.5cm}
\input{macros/scilab2c};
\input{macros/runsci2c};
\input{macros/ToolInitialization/INIT_SCI2C};
\input{macros/ToolInitialization/INIT_GenLibraries};
\input{macros/ToolInitialization/INIT_LoadLibraries};
\input{macros/ToolInitialization/UpdateSCI2CInfo};
\input{macros/ASTManagement/AST_GetASTFile};
\end{document}